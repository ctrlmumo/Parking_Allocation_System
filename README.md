Backend parking slot allocation system that helps drivers find available parking spots and allows parking lot managers to manage space allocation efficiently.
